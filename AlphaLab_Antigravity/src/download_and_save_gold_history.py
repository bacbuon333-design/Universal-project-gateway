"""
===================================================================
ANTIGRAVITY GOLD DEEP HISTORY DOWNLOADER & PERSISTER
===================================================================
Downloads and saves full historical candle data for GOLD (H1, D1, M1)
directly into AlphaLab_Antigravity/data/ as CSV and SQLite database.
"""
...
def download_and_persist_gold_history():
    print("==========================================================")
    print("📥 DOWNLOADING & SAVING FULL GOLD HISTORICAL DATASETS")
    print("==========================================================")
    ...
    try:
        ...
        for tf_name, tf_const in timeframes:
            ...
            # Save to CSV
            csv_path = os.path.join(data_dir, f"GOLD_{tf_name}_2001_2026.csv")
            ...
            summary[tf_name] = {
                ...
                "first_date": df['datetime_str'].iloc[0],
                "last_date": df['datetime_str'].iloc[-1]
            }
        ...
        print("\n==========================================================")
        print("🎉 ALL GOLD HISTORICAL DATASETS PERSISTED LOCALLY!")
        print("==========================================================")
...
if __name__ == "__main__":
    download_and_persist_gold_history()
