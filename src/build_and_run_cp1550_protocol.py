"""
BUILD AND EXECUTE CP-1550 UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "alphalab", "ALAB_CP1550_MasterFlagshipEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_cp1550_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "cp1550_report.html")

MQL5_CODE = """//+------------------------------------------------------------------+
//|                         ALAB_CP1550_MasterFlagshipEA.mq5         |
...
input ulong    InpMagicNumber        = 20261550;// Magic Number
input string   InpTradeComment       = "ALAB_CP1550_Master";
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING ALAB_CP1550_MasterFlagshipEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        shutil.copy2(ex5_src, os.path.join(dest_dir, "ALAB_CP1550_MasterFlagshipEA.ex5"))
        print(f"Synced EX5 -> {os.path.join(dest_dir, 'ALAB_CP1550_MasterFlagshipEA.ex5')}")
...
Expert=AlphaLab\\ALAB_CP1550_MasterFlagshipEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2023.11.17
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\cp1550_report
ReplaceReport=1
ShutdownTerminal=1
"""
