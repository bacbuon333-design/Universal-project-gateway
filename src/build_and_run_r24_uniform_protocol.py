"""
BUILD AND EXECUTE ALPHALAB R24 UNIFORM EA UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "CleanRoom", "AlphaLabR24_GoldMasterUniformEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_r24_uniform_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "r24_uniform_report.htm")
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING AlphaLabR24_GoldMasterUniformEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        dest_file = os.path.join(dest_dir, "AlphaLabR24_GoldMasterUniformEA.ex5")
...
Expert=AlphaLab\\CleanRoom\\AlphaLabR24_GoldMasterUniformEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
