"""
PREREGISTRATION MANIFEST FOR CP-750 DUAL-REGIME INDEX ENGINE
============================================================
"""
...
MANIFEST_PATH = os.path.join(GOV_DIR, "cp750_dual_regime_index_v1.json")

manifest_data = {
    "version": "1.0",
    "architecture_name": "ALAB_CP750_DualRegimeEA",
    "hypothesis": "Dynamic dual-timeframe regime alignment (H1 EMA20/50 trend direction + M15 Bollinger breakout and RSI momentum) with symmetric BUY and SELL execution. 100% causal closed-bar signals (shift 1), per-tick hard equity drawdown protection, and exact risk budget sizing using OrderCalcProfit.",
    "target_asset": "GOLD",
    "period": "M15",
    ...
    "directional_rules": {
        ...
        "buy_condition": "H1 EMA20 > EMA50 AND M15 EMA9 > EMA20 AND Close > Upper BB AND RSI > 52.0",
        "sell_condition": "H1 EMA20 < EMA50 AND M15 EMA9 < EMA20 AND Close < Lower BB AND RSI < 48.0"
    },
    "execution_contract": {
        "shift_index": 1,
