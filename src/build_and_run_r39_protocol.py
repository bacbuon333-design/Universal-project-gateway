"""
BUILD AND EXECUTE ALPHALAB R39 GOLD 4K COMPOUNDING MASTER EA UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "CleanRoom", "AlphaLabR39_Gold4KCompoundingMasterEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_r39_gold_exec_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "r39_gold_exec_report.htm")
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING AlphaLabR39_Gold4KCompoundingMasterEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        dest_file = os.path.join(dest_dir, "AlphaLabR39_Gold4KCompoundingMasterEA.ex5")
...
Expert=AlphaLab\\CleanRoom\\AlphaLabR39_Gold4KCompoundingMasterEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2022.05.01
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\r39_gold_exec_report
ReplaceReport=1
ShutdownTerminal=1

[TesterInputs]
InpBaseRiskPct=0.068
InpAccelStepMult=5.85
InpDDBrakeThreshPct=0.055
InpDDBrakeRiskMult=0.12
InpTakeProfitATRMult=4.20
InpStopLossATRMult=1.10
InpShortSLMult=1.85
InpMaxDrawdownLimit=0.20
InpMagicNumber=202639001
InpTradeComment=ALAB_R39_GOLD_4K
"""
