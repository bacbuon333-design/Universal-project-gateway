"""
BUILD AND EXECUTE ALPHALAB R36 GOLD MASTER COMPOUNDING EA UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
===================================================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "CleanRoom", "AlphaLabR36_GoldMasterCompoundingEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_r36_gold_exec_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "r36_gold_exec_report.htm")
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING AlphaLabR36_GoldMasterCompoundingEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        dest_file = os.path.join(dest_dir, "AlphaLabR36_GoldMasterCompoundingEA.ex5")
...
Expert=AlphaLab\\CleanRoom\\AlphaLabR36_GoldMasterCompoundingEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2022.05.01
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\r36_gold_exec_report
ReplaceReport=1
ShutdownTerminal=1

[TesterInputs]
InpBaseRiskPct=0.058
InpAccelStepMult=3.65
InpDDBrakeThreshPct=0.055
InpDDBrakeRiskMult=0.15
InpTakeProfitATRMult=3.80
InpStopLossATRMult=1.10
InpShortSLMult=1.85
InpMaxDrawdownLimit=0.20
InpMagicNumber=202636001
InpTradeComment=ALAB_R36_GOLD_4K
"""
