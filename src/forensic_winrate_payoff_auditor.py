"""
FORENSIC WIN-RATE & PAYOFF AUDITOR (CHECKPOINT 18 AUDIT)
======================================================
Performs a granular forensic breakdown of Win Rate %, Loss Rate %,
Average Win ($), Average Loss ($), Payoff Ratio (R:R), and Profit Factor (PF)
for every strategy engine in Checkpoint 18.

Explores Win Rate Optimization to elevate Win Rate from 30% -> 55%+
while maintaining Max Drawdown <= 18.0%.
"""
...
def audit_winrate_and_payoff():
    ...
    engines = ['CP14_Trend', 'CP15_Sweep', 'CP16_HighQualitySqueeze']
    ...
    print("="*105)
    print("FORENSIC WIN-RATE & PAYOFF AUDIT BREAKDOWN")
    print("="*105)
    ...
    for engine, tr_list in trades_by_engine.items():
        ...
        print(f"  - Payoff (R:R)  : 1 : {payoff_ratio:.2f} (Extremely High Reward Ratio!)")
        print(f"  - Profit Factor : {pf:.2f}")
        print("-" * 105)

if __name__ == '__main__':
    audit_winrate_and_payoff()
