"""
OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER EXECUTION: 10X AGGRESSIVE COMPOUNDING TEST
========================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_Strategy1_HighYieldSafe.ex5 with 3.5%-5.0% Risk Scaling across 2010 to 2026.
...
INI_PATH = os.path.join(BASE_DIR, "run_s1_10x_aggressive.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_10x_aggressive_report.html")
...
def run_10x_aggressive_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING OFFICIAL METATRADER 5 TESTER: 10X AGGRESSIVE COMPOUNDING TEST")
    print("Binary EA   : ALAB_Strategy1_HighYieldSafe.ex5 (3.5% - 5.0% Dynamic Risk)")
    ...
    while proc.poll() is None and elapsed < 180:
        time.sleep(3)
        elapsed += 3
        print(f"   [MT5 10x Aggressive Tester Running] Elapsed: {elapsed}s...", end='\r')
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 10X AGGRESSIVE TESTER RESULTS")
    print("="*105)
