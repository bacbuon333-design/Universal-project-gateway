"""
BUILD AND EXECUTE CP-760 UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
===================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "alphalab", "ALAB_CP760_DualRegimeEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_cp760_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "cp760_report.html")

MQL5_CODE = """//+------------------------------------------------------------------+
//|                                    ALAB_CP760_DualRegimeEA.mq5   |
...
input ulong    InpMagicNumber        = 2026760;// Magic Number
input string   InpTradeComment       = "ALAB_CP760_DualRegime";
...
void OnTick()
{
   ...
   bool buy_signal  = macro_bull && (ema9_m15[0] > ema20_m15[0]) && (close > ema9_m15[0]) && (rsi[0] > 50.0);
   bool sell_signal = macro_bear && (ema9_m15[0] < ema20_m15[0]) && (close < ema9_m15[0]) && (rsi[0] < 50.0);
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING ALAB_CP760_DualRegimeEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        shutil.copy2(ex5_src, os.path.join(dest_dir, "ALAB_CP760_DualRegimeEA.ex5"))
        print(f"Synced EX5 -> {os.path.join(dest_dir, 'ALAB_CP760_DualRegimeEA.ex5')}")
...
Expert=AlphaLab\\ALAB_CP760_DualRegimeEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2022.05.01
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\cp760_report
ReplaceReport=1
ShutdownTerminal=1
"""
    ...
    print("="*115)
    print("STEP 4: READING AND EVALUATING OFFICIAL MT5 HTML REPORT (cp760_report.html)")
    print("="*115)
