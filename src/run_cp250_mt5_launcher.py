"""
AUTOMATED MT5 STRATEGY TESTER LAUNCHER FOR CP-250
===============================================
Launches XM Global MT5 Strategy Tester pre-configured with CP-250.
"""
...
INI_PATH = os.path.join(DATA_DIR, "cp250_test.ini")

def launch_cp250_mt5():
...
"""
    ...
    print("MT5 Strategy Tester window launched on desktop with CP-250 pre-loaded!")
