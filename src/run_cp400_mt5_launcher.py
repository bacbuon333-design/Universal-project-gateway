"""
AUTOMATED MT5 STRATEGY TESTER LAUNCHER FOR CP-400 MASTER FLAGSHIP
==================================================================
Launches XM Global MT5 Strategy Tester pre-configured with CP-400.
"""
...
INI_PATH = os.path.join(DATA_DIR, "cp400_test.ini")

def launch_cp400_mt5():
...
"""
    ...
    print("MT5 Strategy Tester window launched on desktop with CP-400 Master Flagship pre-loaded!")
