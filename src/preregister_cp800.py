"""
PREREGISTRATION MANIFEST FOR CP-800 ROBUST TREND BREAKOUT EA
============================================================
"""
...
MANIFEST_PATH = os.path.join(GOV_DIR, "cp800_robust_trend_breakout_v1.json")

manifest_data = {
    "version": "1.0",
    "architecture_name": "ALAB_CP800_RobustTrendBreakoutEA",
    "hypothesis": "Multi-timeframe trend alignment (H1 EMA9/20 trend direction) combined with M15 price-action structure breakout (Donchian high/low breakout) and RSI momentum filter. 100% causal closed-bar signals (shift 1), per-tick hard equity drawdown protection, and exact risk budget sizing using OrderCalcProfit.",
    "target_asset": "GOLD",
    "period": "M15",
    ...
    "directional_rules": {
        ...
        "buy_condition": "H1 EMA9 > EMA20 AND M15 Close[1] > High[2] AND RSI > 50.0",
        "sell_condition": "H1 EMA9 < EMA20 AND M15 Close[1] < Low[2] AND RSI < 50.0"
    },
    "execution_contract": {
        "shift_index": 1,
