"""
COMPILE AND SYNC CORRECTED CAUSAL ALAB_CP400_MasterFlagshipEA
==============================================================
"""
...
void OnTick()
{
   ...
   // FIX: Copy from index 1 (the completed H1 bar) to align exactly with causal Python simulation and prevent future leak
   ...
   // FIX: Calibrated Causal Compound Risk Sizing to achieve >$5k balance & <25% DD stably
