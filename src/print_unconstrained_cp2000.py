"""
PRINT UNCONSTRAINED TOP CP-2000 CONFIGURATIONS
===============================================
"""
...
def run_test():
    ...
    for base_risk in [0.045, 0.050, 0.055, 0.060, 0.065]:
        for dd_step1 in [0.07, 0.08, 0.09]:
            for dd_step2 in [0.12, 0.14]:
                for risk_mult1 in [0.35, 0.40]:
                    for risk_mult2 in [0.15, 0.20]:
                        for sl_mult in [1.0, 1.1]:
                            for tp_mult in [3.2, 3.5, 3.8]:
                                ...
                                all_configs.append((balance, net_p, wr, max_dd_pct, pf, total_t, base_risk, dd_step1, dd_step2, risk_mult1, risk_mult2, sl_mult, tp_mult))
                                
    all_configs.sort(key=lambda x: x[0], reverse=True)
    print("Top 15 Unconstrained CP-2000 Configurations:")
