"""
BUILD AND EXECUTE ALPHALAB R29 M15 MASTER COMPOUNDING EA UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "CleanRoom", "AlphaLabR29_M15MasterCompoundingEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_r29_gold_exec_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "r29_gold_exec_report.htm")
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING AlphaLabR29_M15MasterCompoundingEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        dest_file = os.path.join(dest_dir, "AlphaLabR29_M15MasterCompoundingEA.ex5")
...
Expert=AlphaLab\\CleanRoom\\AlphaLabR29_M15MasterCompoundingEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2022.05.01
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\r29_gold_exec_report
ReplaceReport=1
ShutdownTerminal=1

[TesterInputs]
InpBaseRiskPct=0.048
InpAccelStepMult=2.45
InpDDBrakeThreshPct=0.060
InpDDBrakeRiskMult=0.15
InpTakeProfitATRMult=3.80
InpStopLossATRMult=1.25
InpShortSLMult=1.85
InpMaxDrawdownLimit=0.20
InpMagicNumber=202629001
InpTradeComment=ALAB_R29_M15_5K
"""
