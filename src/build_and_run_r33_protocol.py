"""
BUILD AND EXECUTE ALPHALAB R33 M15 HIGH-DENSITY MASTER EA UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "CleanRoom", "AlphaLabR33_M15HighDensityMasterEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_r33_gold_exec_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "r33_gold_exec_report.htm")
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING AlphaLabR33_M15HighDensityMasterEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        dest_file = os.path.join(dest_dir, "AlphaLabR33_M15HighDensityMasterEA.ex5")
...
Expert=AlphaLab\\CleanRoom\\AlphaLabR33_M15HighDensityMasterEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2022.05.01
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\r33_gold_exec_report
ReplaceReport=1
ShutdownTerminal=1

[TesterInputs]
InpBaseRiskPct=0.056
InpAccelStepMult=3.25
InpDDBrakeThreshPct=0.058
InpDDBrakeRiskMult=0.15
InpTakeProfitATRMult=3.60
InpStopLossATRMult=1.10
InpShortSLMult=1.85
InpMaxDrawdownLimit=0.20
InpMagicNumber=202633001
InpTradeComment=ALAB_R33_M15_5K
"""
