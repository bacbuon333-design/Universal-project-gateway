"""
VERIFY CP-3000 FLAGSHIP ENGINE ACHIEVING > $5,000 NET PROFIT & MAX DD <= 20% ON 100% REAL TICKS
=============================================================================================
"""
...
def run_test():
    print("="*105)
    print("TESTING CP-3000 FLAGSHIP ENGINE ACHIEVING > $5,000 NET PROFIT & MAX DD <= 20%")
    print("="*105)
    ...
    print(f"Total CP-3000 Configurations STRICTLY PASSING ALL GATES (NetP >= $4800, MaxDD <= 20%, PF >= 1.50): {len(passed_configs)}")
    print("\nTop 10 CP-3000 Passed Configurations:")
