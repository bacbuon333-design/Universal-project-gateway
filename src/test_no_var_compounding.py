"""
NO-VAR CIRCUIT BREAKER COMPOUNDING TEST (2010 - 2026)
=====================================================
Tests Checkpoint 2/3 Strategy (ADX > 20 + Session 12-18 GMT + ATR 2x/4x)
WITHOUT any Monthly VaR Circuit Breaker cap.
- Continuous compounding from $1,000 initial capital (3.0% risk per trade).
- Separate year-by-year test with fresh $1,000 capital every year.
"""
...
def run_no_var_test(risk_pct=0.03, continuous=True):
...
bal, pct, dd, n_tr, wr, pf = run_no_var_test(risk_pct=0.03, continuous=True)

print("="*85)
print("TEST UPGRADED MODEL WITHOUT VAR CIRCUIT BREAKER (3.0% RISK COMPOUNDING)")
print("Dataset: XAUUSD H1 (2010 - 2026, 16.57 Years)")
print("="*85)
print(f"Initial Capital (2010) : $1,000.00 USD")
print(f"Final Balance (2026)   : ${bal:,.2f} USD")
