"""
BUILD AND EXECUTE ALPHALAB R37 GOLD COMPOUNDING MASTER EA UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
===================================================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "CleanRoom", "AlphaLabR37_GoldCompoundingMasterEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_r37_gold_exec_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "r37_gold_exec_report.htm")
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING AlphaLabR37_GoldCompoundingMasterEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        dest_file = os.path.join(dest_dir, "AlphaLabR37_GoldCompoundingMasterEA.ex5")
...
Expert=AlphaLab\\CleanRoom\\AlphaLabR37_GoldCompoundingMasterEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2022.05.01
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\r37_gold_exec_report
ReplaceReport=1
ShutdownTerminal=1
...
InpMagicNumber=202637001
InpTradeComment=ALAB_R37_GOLD_4K
"""
