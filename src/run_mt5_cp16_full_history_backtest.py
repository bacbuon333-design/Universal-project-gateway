"""
OFFICIAL METATRADER 5 FULL HISTORY MAXIMUM DEPTH BACKTEST: CHECKPOINT 16 (ALAB_CP16_TripleIsolation.ex5)
====================================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_CP16_TripleIsolation.ex5 on GOLD H1 across FULL MAXIMUM HISTORICAL DATA (2010 to 2026).
...
INI_PATH = os.path.join(BASE_DIR, "run_cp16_full_history.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_cp16_full_history_report.html")

os.makedirs(os.path.dirname(REPORT_PATH), exist_ok=True)

ini_content = f"""[Tester]
Expert=AlphaLab\\alphalab\\ALAB_CP16_TripleIsolation.ex5
Symbol=GOLD
Period=H1
Deposit=1000
Currency=USD
...
def run_cp16_full_history_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING MT5 NATIVE STRATEGY TESTER: FULL MAXIMUM HISTORY DEPTH (2010 - 2026)")
    print("Binary EA   : ALAB_CP16_TripleIsolation.ex5")
    ...
    while proc.poll() is None and elapsed < 180:
        time.sleep(3)
        elapsed += 3
        print(f"   [MT5 Strategy Tester Full History Running] Elapsed: {elapsed}s...", end='\r')
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 FULL HISTORY TESTER RESULTS: CHECKPOINT 16")
    print("="*105)
...
if __name__ == '__main__':
    run_cp16_full_history_backtest()
