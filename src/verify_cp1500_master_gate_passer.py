"""
VERIFY CP-1500 MASTER GATE PASSER ON 100% REAL TICKS
===================================================
"""
...
def run_test():
    print("="*105)
    print("TESTING CP-1500 MASTER GATE PASSER ON 100% REAL TICK DATASET (2023.11.17 TO 2026.07.27)")
    print("="*105)
    ...
    for base_risk in [0.025, 0.028, 0.030, 0.032, 0.035]:
        for dd_brake_thresh in [0.06, 0.07, 0.08]:
            for dd_risk_scale in [0.30, 0.35, 0.40]: # Cut risk by 60-70% during DD
                for sl_mult in [1.0, 1.1]:
                    for tp_mult in [2.8, 3.0, 3.2]:
                        balance = 1000.0
                        ...
                        if net_p >= 800.0 and max_dd_pct <= 0.20 and pf >= 1.50 and wr >= 38.0:
    ...
    print(f"Total Configurations STRICTLY PASSING ALL TARGET GATES (MaxDD <= 20%, PF >= 1.50): {len(passed_configs)}")
    print("\nTop 10 CP-1500 Passed Configurations:")
