"""
COMPILE AND DEPLOY CP-400 MASTER FLAGSHIP EA TO ALL MT5 TERMINALS
===================================================================
Compiles ALAB_CP400_MasterFlagshipEA.mq5 via MetaEditor
and copies ALAB_CP400_MasterFlagshipEA.ex5 directly to MQL5\\Experts\\AlphaLab\\ across all MT5 terminals.
"""
...
def compile_and_deploy_cp400():
    print("="*105)
    print("COMPILING AND DEPLOYING CP-400 MASTER FLAGSHIP EA TO ALL MT5 TERMINALS")
    print("="*105)
    ...
    print("="*105)
    print("CP-400 MASTER FLAGSHIP IS NOW INSTANTLY VISIBLE IN MT5 STRATEGY TESTER!")

if __name__ == '__main__':
    compile_and_deploy_cp400()
