"""
BUILD AND EXECUTE CP-15000 UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
=====================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "alphalab", "ALAB_CP15000_Master5KGrandmasterEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_cp15000_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "cp15000_report.html")

MQL5_CODE = """//+------------------------------------------------------------------+
//|                     ALAB_CP15000_Master5KGrandmasterEA.mq5       |
...
input double   InpAccelStepMult      = 1.800;  // Risk Acceleration Multiplier (1.80x)
input double   InpDDBrakeThreshPct   = 0.055;  // Drawdown Brake Trigger (5.5%)
input double   InpDDBrakeRiskMult    = 0.150;  // Risk Multiplier in DD Brake (0.15x)
input double   InpMaxDrawdownLimit   = 0.200;  // Maximum Equity Drawdown Cutoff (20.0%)
input ulong    InpMagicNumber        = 202615000;// Magic Number
input string   InpTradeComment       = "ALAB_CP15000_5K";
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING ALAB_CP15000_Master5KGrandmasterEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        shutil.copy2(ex5_src, os.path.join(dest_dir, "ALAB_CP15000_Master5KGrandmasterEA.ex5"))
        print(f"Synced EX5 -> {os.path.join(dest_dir, 'ALAB_CP15000_Master5KGrandmasterEA.ex5')}")
...
Expert=AlphaLab\\ALAB_CP15000_Master5KGrandmasterEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2023.11.17
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\cp15000_report
ReplaceReport=1
ShutdownTerminal=1
"""
