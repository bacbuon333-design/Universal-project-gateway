"""
BUILD AND EXECUTE CP-30000 UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
=====================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "alphalab", "ALAB_CP30000_Master5KUltimateVictoryEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_cp30000_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "cp30000_report.html")

MQL5_CODE = """//+------------------------------------------------------------------+
//|                  ALAB_CP30000_Master5KUltimateVictoryEA.mq5      |
...
input double   InpBaseRiskPct        = 0.050;  // Base Risk Per Trade (5.0%)
input double   InpAccelStepMult      = 1.950;  // Risk Acceleration Multiplier (1.95x)
input double   InpDDBrakeThreshPct   = 0.045;  // Drawdown Brake Trigger (4.5%)
input double   InpDDBrakeRiskMult    = 0.120;  // Risk Multiplier in DD Brake (0.12x)
input double   InpMaxDrawdownLimit   = 0.200;  // Maximum Equity Drawdown Cutoff (20.0%)
input ulong    InpMagicNumber        = 202630000;// Magic Number
input string   InpTradeComment       = "ALAB_CP30000_5K";
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING ALAB_CP30000_Master5KUltimateVictoryEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        shutil.copy2(ex5_src, os.path.join(dest_dir, "ALAB_CP30000_Master5KUltimateVictoryEA.ex5"))
        print(f"Synced EX5 -> {os.path.join(dest_dir, 'ALAB_CP30000_Master5KUltimateVictoryEA.ex5')}")
...
Expert=AlphaLab\\ALAB_CP30000_Master5KUltimateVictoryEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2023.11.17
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\cp30000_report
ReplaceReport=1
ShutdownTerminal=1
"""
