"""
PRINT UNCONSTRAINED TOP CP-1300 CONFIGURATIONS
===============================================
"""
...
def run_test():
    ...
    for base_risk in [0.025, 0.030, 0.035, 0.040, 0.045, 0.050]:
        for sl_factor in [0.9, 1.0, 1.1]:
            for tp1_factor in [1.0, 1.2, 1.4]:
                for tp2_factor in [2.2, 2.5, 3.0]:
                    balance = 1000.0
                    ...
                    for i in range(200, n - 1):
                        ...
                        if b_sig and (i - last_idx >= 3):
                            ...
                            for j in range(i + 1, min(i + 240, n)):
                                ...
                                if not pos2_done:
                                    if tp1_hit: pos2_sl = entry_price + 0.10
                    ...
                    all_configs.append((balance, net_p, wr, max_dd_pct, pf, total_t, base_risk, sl_factor, tp1_factor, tp2_factor))
                        
    all_configs.sort(key=lambda x: x[0], reverse=True)
    print("Top 15 Unconstrained CP-1300 Configurations:")
