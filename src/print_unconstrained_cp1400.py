"""
PRINT UNCONSTRAINED TOP CP-1400 CONFIGURATIONS
===============================================
"""
            ...
            for dd_risk_scale in [0.25, 0.35, 0.50]:
                for sl_mult in [1.0, 1.1]:
                    for tp_mult in [2.6, 2.8, 3.0]:
                        ...
                        all_configs.append((balance, net_p, wr, max_dd_pct, pf, total_t, base_risk, dd_brake_thresh, dd_risk_scale, sl_mult, tp_mult))
                        
    all_configs.sort(key=lambda x: x[0], reverse=True)
    print("Top 15 Unconstrained CP-1400 Configurations:")
