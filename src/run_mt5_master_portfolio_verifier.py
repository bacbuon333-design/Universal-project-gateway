"""
OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER EXECUTION: MASTER TRIPLE PORTFOLIO MANAGER
========================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_TriplePortfolioManager.ex5 (Master Unified Triple Engine) across GOLD H1 (2010 to 2026).
...
INI_PATH = os.path.join(BASE_DIR, "run_master_portfolio.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_master_portfolio_report.html")

os.makedirs(os.path.dirname(REPORT_PATH), exist_ok=True)

ini_content = f"""[Tester]
Expert=AlphaLab\\alphalab\\ALAB_TriplePortfolioManager.ex5
Symbol=GOLD
Period=H1
Deposit=1000
Currency=USD
...
def run_master_portfolio_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING OFFICIAL METATRADER 5 TESTER: MASTER TRIPLE PORTFOLIO MANAGER")
    print("Binary EA   : ALAB_TriplePortfolioManager.ex5 (Master Unified Single EA)")
    ...
    while proc.poll() is None and elapsed < 180:
        time.sleep(3)
        elapsed += 3
        print(f"   [MT5 Master Portfolio Tester Running] Elapsed: {elapsed}s...", end='\r')
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 MASTER TRIPLE PORTFOLIO TESTER RESULTS")
    print("="*105)
