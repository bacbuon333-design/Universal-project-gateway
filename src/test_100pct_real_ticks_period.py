"""
TEST NATIVE MT5 MODEL=4 ON 100% REAL TICK PERIOD (2023.11.17 to 2026.07.27)
========================================================================
"""
...
INI_PATH = os.path.join(DATA_DIR, "generate_real_ticks_quality.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "real_ticks_quality_report.html")

def test_period():
    print("="*105)
    print("TESTING NATIVE MT5 MODEL=4 HISTORY QUALITY FROM 2023.11.17 TO 2026.07.27")
    print("="*105)
...
FromDate=2023.11.17
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\real_ticks_quality_report
ReplaceReport=1
ShutdownTerminal=1
"""
