"""
OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER EXECUTION: 10X HYPER-COMPOUNDING GAUNTLET
======================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_Strategy1_HighYieldSafe.ex5 with Dynamic Compounding Buffer Scaling across 2010 to 2026.
...
INI_PATH = os.path.join(BASE_DIR, "run_s1_10x_compounding.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_10x_compounding_report.html")
...
def run_10x_compounding_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING OFFICIAL METATRADER 5 TESTER: 10X HYPER-COMPOUNDING GAUNTLET")
    print("Binary EA   : ALAB_Strategy1_HighYieldSafe.ex5 (Dynamic Compounding Enabled)")
    ...
    while proc.poll() is None and elapsed < 180:
        time.sleep(3)
        elapsed += 3
        print(f"   [MT5 10x Compounding Tester Running] Elapsed: {elapsed}s...", end='\r')
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 10X COMPOUNDING TESTER RESULTS")
    print("="*105)
