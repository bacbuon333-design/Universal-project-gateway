"""
PREREGISTRATION MANIFEST FOR CP-760 DUAL-REGIME INDEX ENGINE
============================================================
"""
...
MANIFEST_PATH = os.path.join(GOV_DIR, "cp760_dual_regime_index_v1.json")

manifest_data = {
    "version": "1.0",
    "architecture_name": "ALAB_CP760_DualRegimeEA",
    "hypothesis": "Causal dual-timeframe momentum trend alignment (H1 EMA20/50 direction + M15 EMA9/20 crossover and RSI filter) with symmetric BUY and SELL execution. 100% causal closed-bar signals (shift 1), per-tick hard equity drawdown protection, and exact risk budget sizing using OrderCalcProfit.",
    "target_asset": "GOLD",
    "period": "M15",
    ...
    "directional_rules": {
        ...
        "buy_condition": "H1 EMA20 > EMA50 AND M15 EMA9 > EMA20 AND Close > EMA9_M15 AND RSI > 50.0",
        "sell_condition": "H1 EMA20 < EMA50 AND M15 EMA9 < EMA20 AND Close < EMA9_M15 AND RSI < 50.0"
    },
    "execution_contract": {
        "shift_index": 1,
