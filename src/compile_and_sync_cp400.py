"""
COMPILE & SYNC CP-400 EA WITH DETAILED LOGS
=============================================
"""
...
void OnTick()
{
   ...
   Print("DIAGNOSTIC LOG: balance=", balance, " active_risk_pct=", active_risk_pct, " risk_amount=", risk_amount, " sl_dist=", sl_dist, " loss_per_lot=", loss_per_lot, " calculated_lot_size=", lot_size, " tick_val=", tick_val, " tick_sz=", tick_sz);
...
def run_compile_and_sync():
    print("="*105)
    print("COMPILING & SYNCING ALAB_CP400_MasterFlagshipEA.mq5 ACROSS ALL MT5 TERMINALS")
    print("="*105)
    ...
    if os.path.exists(ex5_src):
        print(f"SUCCESSFULLY COMPILED EX5")
