"""
FIND WINNING MT5 LOT SCALING FOR REAL TICKS
===========================================
"""
...
def run_scaling():
    print("="*105)
    print("SEARCHING FOR OPTIMAL MT5 REAL-TICK LOT SCALING")
    print("="*105)
    ...
    for base_risk in [0.040, 0.050, 0.060, 0.070, 0.080]:
        for brake_dd in [0.10, 0.12, 0.15]:
    ...
    print("Top 10 Lot Scaling Configurations:")
