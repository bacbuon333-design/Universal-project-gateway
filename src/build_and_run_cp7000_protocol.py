"""
BUILD AND EXECUTE CP-7000 UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "alphalab", "ALAB_CP7000_Master5KUltimateEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_cp7000_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "cp7000_report.html")

MQL5_CODE = """//+------------------------------------------------------------------+
//|                       ALAB_CP7000_Master5KUltimateEA.mq5         |
...
input ulong    InpMagicNumber        = 20267000;// Magic Number
input string   InpTradeComment       = "ALAB_CP7000_5K";
...
void OnTick()
{
   ...
   bool buy_signal = macro_bull && m15_bull && vol_exp && (close1 > upper_bb[0]) && (rsi[0] > 55.0) && (lwick >= 0.80 * body) && consec_bull;
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING ALAB_CP7000_Master5KUltimateEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        shutil.copy2(ex5_src, os.path.join(dest_dir, "ALAB_CP7000_Master5KUltimateEA.ex5"))
        print(f"Synced EX5 -> {os.path.join(dest_dir, 'ALAB_CP7000_Master5KUltimateEA.ex5')}")
...
Expert=AlphaLab\\ALAB_CP7000_Master5KUltimateEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2023.11.17
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\cp7000_report
ReplaceReport=1
ShutdownTerminal=1
"""
