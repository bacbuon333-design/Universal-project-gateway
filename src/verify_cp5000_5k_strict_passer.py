"""
VERIFY CP-5000 MASTER ENGINE ACHIEVING > $5,000 NET PROFIT AND MAX DD <= 20% ON 100% REAL TICKS
============================================================================================
"""
...
def run_test():
    print("="*105)
    print("TESTING CP-5000 MASTER ENGINE ACHIEVING > $5,000 NET PROFIT AND MAX DD <= 20%")
    print("="*105)
    ...
    for base_risk in [0.035, 0.038, 0.040]:
        for accel_step in [1.65, 1.70, 1.75]:
            for dd_thresh in [0.05, 0.06, 0.07]:
                for dd_mult in [0.12, 0.15, 0.18]:
                    for sl_mult in [1.0, 1.1]:
                        for tp_mult in [3.8, 4.0, 4.2]:
                            balance = 1000.0
    ...
    print(f"Total CP-5000 Configurations STRICTLY PASSING ALL GATES (NetP >= $5000, MaxDD <= 20%, PF >= 1.50): {len(passed_configs)}")
    print("\nTop 10 CP-5000 Passed Configurations:")
