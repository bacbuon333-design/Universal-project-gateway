"""
OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER EXECUTION: CHECKPOINT 16 (ALAB_CP16_TripleIsolation.ex5)
==================================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_CP16_TripleIsolation.ex5 on GOLD H1 (XM Global MT5 Server Data).
...
INI_PATH = os.path.join(BASE_DIR, "run_cp16_mt5.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_cp16_report.html")
...
def run_cp16_mt5_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER: CHECKPOINT 16")
    print("Binary EA   : ALAB_CP16_TripleIsolation.ex5")
    print("Dataset     : GOLD H1 / Real Ticks (XM Global Server)")
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 NATIVE TESTER RESULTS: CHECKPOINT 16")
    print("="*105)
