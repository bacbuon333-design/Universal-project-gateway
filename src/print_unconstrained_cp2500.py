"""
PRINT UNCONSTRAINED TOP CP-2500 CONFIGURATIONS
===============================================
"""
...
def run_test():
    ...
    for base_risk in [0.035, 0.040, 0.045, 0.050]:
        for accel_step in [1.2, 1.3, 1.4, 1.5]:
            for dd_thresh in [0.06, 0.07, 0.08]:
                for dd_mult in [0.25, 0.30, 0.35]:
    ...
    print("Top 15 Unconstrained CP-2500 Configurations:")
