"""
CHECKPOINT 5 CONTINUOUS COMPOUNDING FROM 2021 TO 2026
=====================================================
Starting with $1,000 INITIAL CAPITAL on Jan 1, 2021 and letting CP5
...
def run_cp5_from_2021(risk_pct=0.025):
...
bal5, pct5, dd5, n5, wr5, pf5, eq_hist = run_cp5_from_2021(risk_pct=0.025)

print("="*85)
print("CHECKPOINT 5 CONTINUOUS COMPOUNDING FROM 2021 TO JULY 2026")
print("Initial Capital (Jan 1, 2021): 1000.00 USD")
print("="*85)
...
print("\n📈 YEAR-BY-YEAR COMPOUNDING BALANCE PROGRESSION (2021 - 2026):")
print("-" * 55)
