"""
OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER EXECUTION: CHECKPOINT 1 BASELINE (ALAB_CP01_Baseline.ex5)
===================================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_CP01_Baseline.ex5 on GOLD H1 across FULL MAXIMUM HISTORICAL DATA (2010 to 2026).
...
INI_PATH = os.path.join(BASE_DIR, "run_cp01_full_history.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_cp01_full_history_report.html")

os.makedirs(os.path.dirname(REPORT_PATH), exist_ok=True)

ini_content = f"""[Tester]
Expert=AlphaLab\\alphalab\\ALAB_CP01_Baseline.ex5
Symbol=GOLD
Period=H1
Deposit=1000
Currency=USD
...
def run_cp01_mt5_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER: CHECKPOINT 1 BASELINE")
    print("Binary EA   : ALAB_CP01_Baseline.ex5")
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 TESTER RESULTS: CHECKPOINT 1 BASELINE")
    print("="*105)
