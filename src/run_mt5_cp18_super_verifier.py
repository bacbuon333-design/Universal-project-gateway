"""
OFFICIAL METATRADER 5 NATIVE STRATEGY TESTER EXECUTION: CHECKPOINT 18 (SUPER PORTFOLIO MANAGER)
==================================================================================================
Launches terminal64.exe CLI with batch INI config to run native C++ Strategy Tester
on ALAB_CP18_SuperPortfolioManager.ex5 on GOLD H1 across FULL MAXIMUM HISTORICAL DATA (2010 to 2026).
...
INI_PATH = os.path.join(BASE_DIR, "run_cp18_super.ini")
REPORT_PATH = os.path.join(BASE_DIR, "reports", "official_mt5_cp18_super_report.html")

os.makedirs(os.path.dirname(REPORT_PATH), exist_ok=True)

ini_content = f"""[Tester]
Expert=AlphaLab\\alphalab\\ALAB_CP18_SuperPortfolioManager.ex5
Symbol=GOLD
Period=H1
Deposit=1000
Currency=USD
...
def run_cp18_super_backtest():
    with open(INI_PATH, 'w', encoding='utf-8') as f:
        f.write(ini_content)
        
    print("="*105)
    print("LAUNCHING OFFICIAL METATRADER 5 TESTER: CHECKPOINT 18 SUPER PORTFOLIO MANAGER")
    print("Binary EA   : ALAB_CP18_SuperPortfolioManager.ex5 (Master 10x Super EA)")
    ...
    while proc.poll() is None and elapsed < 180:
        time.sleep(3)
        elapsed += 3
        print(f"   [MT5 CP-18 Super Tester Running] Elapsed: {elapsed}s...", end='\r')
    ...
    print("="*105)
    print("OFFICIAL METATRADER 5 CHECKPOINT 18 SUPER PORTFOLIO RESULTS")
    print("="*105)
