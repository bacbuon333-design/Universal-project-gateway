"""
BUILD AND EXECUTE CP-9500 UNDER NATIVE MT5 MODEL=4 REAL-TICK PROTOCOL
====================================================================
"""
...
MQL5_SRC = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "alphalab", "ALAB_CP9500_Master5KFinalEA.mq5")
LOG_PATH = MQL5_SRC.replace('.mq5', '.log')
INI_PATH = os.path.join(DATA_DIR, "generate_cp9500_report.ini")
TARGET_REPORT_PATH = os.path.join(DATA_DIR, "MQL5", "Experts", "AlphaLab", "cp9500_report.html")

MQL5_CODE = """//+------------------------------------------------------------------+
//|                         ALAB_CP9500_Master5KFinalEA.mq5          |
...
input double   InpBaseRiskPct        = 0.058;  // Base Risk Per Trade (5.8%)
...
input ulong    InpMagicNumber        = 20269500;// Magic Number
input string   InpTradeComment       = "ALAB_CP9500_5K";
...
def run_protocol():
    ...
    print("="*115)
    print("STEP 2: COMPILING ALAB_CP9500_Master5KFinalEA.mq5 VIA METAEDITOR CLI")
    print("="*115)
    ...
    for root in TERMINAL_ROOTS:
        ...
        shutil.copy2(ex5_src, os.path.join(dest_dir, "ALAB_CP9500_Master5KFinalEA.ex5"))
        print(f"Synced EX5 -> {os.path.join(dest_dir, 'ALAB_CP9500_Master5KFinalEA.ex5')}")
...
Expert=AlphaLab\\ALAB_CP9500_Master5KFinalEA.ex5
Symbol=GOLD
Period=M15
Deposit=1000
Currency=USD
...
FromDate=2023.11.17
ToDate=2026.07.27
Report=MQL5\\Experts\\AlphaLab\\cp9500_report
ReplaceReport=1
ShutdownTerminal=1
"""
