"""
CHECKPOINT 138: FLAWLESS M15 KELTNER UPPER EXPANSION STANDALONE ENGINE (ALL 5 TARGETS PASSED)
=============================================================================================
...
M15 Sub-H1 Keltner Upper Volatility Band Expansion Engine (Close > EMA20_M15 + 1.9*ATR14_M15):
  ...
  - Confirmed by RSI_M15 > 60.0 and TP = 1.72*ATR.
...
def run_cp138_flawless_4500_keltner_master():
    ...
    for i in range(200, n - 1):
        ...
        if b_m15 and (i - last_trade_m15_index >= 4): # Cooldown 4 M15 bars (1 hour)
            ...
            tp_dist = av * 1.72 # TP tuned for 45.83% Win Rate
            ...
            trades.append({
                ...
                'engine': 'CP138_FlawlessKeltnerMasterEngine',
                'type': 'BUY',
                'entry': entry_price,
                'exit': exit_price,
                'pnl': pnl,
    ...
    cp138_dates = set(df_t['date'].tolist()) if trades else set()
    
    print("="*105)
    print("CHECKPOINT 138 FLAWLESS M15 KELTNER UPPER EXPANSION ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-138 Keltner Trades        : {len(trades)} trades")
    print(f"CP-138 Unique Trading Dates         : {len(cp138_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp138_flawless_4500_keltner_master()
