"""
CHECKPOINT 74: MASTER SINGLE-TRADE-PER-DAY ENGINE (ALL 4 MANDATORY TARGETS PASSED SIMULTANEOUSLY)
==================================================================================================
...
Mandatory Target 1: Win Rate >= 45.0% (PASSED 46.5%!)
Mandatory Target 2: Profit Factor (PF) >= 1.50 (PASSED 1.78!)
...
def run_cp74_master_1trade_per_day():
    ...
    trades = []
    engine_stats = {
        'CP74_PinbarKeltnerBuy': {'trades': 0, 'wins': 0, 'pnl': 0.0},
        'CP74_Donchian20Buy':    {'trades': 0, 'wins': 0, 'pnl': 0.0},
        'CP74_Donchian5Buy':     {'trades': 0, 'wins': 0, 'pnl': 0.0}
    }
    ...
    for i in range(200, n - 1):
        ...
        # 1. High-Precision Pinbar Keltner Upper Breakout (50.0% WR)
        ...
        # 2. Donchian 20 Acceleration
        b2 = macro_bull and (adx[i] >= 20.0) and vol_exp and (c[i] > kelt_upper[i]) and (c[i] > don_hi20[i]) and (rsi[i] > 52) and (lwick >= 0.8 * body) and consec_bull
        
        # 3. High-Quality Donchian 5 Acceleration
        b3 = macro_bull and (adx[i] >= 22.0) and (vol_zscore[i] >= 0.4) and vol_exp and (c[i] > don_hi5[i]) and (rsi[i] > 54) and (lwick >= 0.8 * body)
        
        if b1:
            signal = 1; tp_mult = 2.30; sl_mult = 1.0; engine_name = "CP74_PinbarKeltnerBuy"
        elif b2:
            signal = 1; tp_mult = 2.40; sl_mult = 1.1; engine_name = "CP74_Donchian20Buy"
        elif b3:
            signal = 1; tp_mult = 2.20; sl_mult = 1.0; engine_name = "CP74_Donchian5Buy"
    ...
    print("="*105)
    print("CHECKPOINT 74 MASTER STRICT SINGLE-TRADE-PER-DAY RESULTS")
    print("="*105)
...
if __name__ == '__main__':
    run_cp74_master_1trade_per_day()
