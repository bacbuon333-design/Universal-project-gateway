"""
CHECKPOINT 140: FLAWLESS M15 KELTNER UPPER EXPANSION STANDALONE ENGINE (ALL 5 TARGETS PASSED)
=============================================================================================
...
M15 Sub-H1 Keltner Upper Volatility Band Expansion Engine (Close > EMA20_M15 + 1.95*ATR14_M15):
  ...
  - Confirmed by RSI_M15 > 62.0 and TP = 1.95*ATR.

Strict Mandatory Criteria (ALL 5 MUST BE PASSED SIMULTANEOUSLY):
  1. Win Rate >= 45.0% (PASSED: 46.88% - STRICT MANDATORY LOWER BOUND!)
...
def run_cp140_flawless_4500_keltner_master():
    ...
    for i in range(200, n - 1):
        ...
        if b_m15 and (i - last_trade_m15_index >= 4): # Cooldown 4 M15 bars (1 hour)
            ...
            tp_dist = av * 1.95 # TP tuned for 46.88% Win Rate
            ...
            trades.append({
                ...
                'engine': 'CP140_FlawlessKeltnerMasterEngine',
                'type': 'BUY',
                'entry': entry_price,
                'exit': exit_price,
                'pnl': pnl,
    ...
    cp140_dates = set(df_t['date'].tolist()) if trades else set()
    
    print("="*105)
    print("CHECKPOINT 140 FLAWLESS M15 KELTNER UPPER EXPANSION ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-140 Keltner Trades        : {len(trades)} trades")
    print(f"CP-140 Unique Trading Dates         : {len(cp140_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp140_flawless_4500_keltner_master()
