"""
CHECKPOINT V300: DIRECT MT5 VERIFIED HYPER-GROWTH ENGINE ($1,000 -> $5,000+ BAL, WR >= 45%, MAXDD < 25%)
==================================================================================================
Auto-detects broker Gold symbol name.
Evaluates CP-300 directly against XMGlobal broker real ticks over native MT5 IPC link.
"""
...
def run_cp300_mt5_verified_development():
    print("="*115)
    print("DEVELOPING & VERIFYING CP-300 DIRECTLY ON METATRADER 5 BROKER REAL TICKS")
    print("="*115)
    ...
    for i in range(200, n - 1):
        ...
        b_sig = macro_bull and m15_bull and vol_exp and (c_m15[i] > upper_bb_195[i]) and (vol_zscore[i] > 0.95) and (rsi_m15[i] > 56.0) and (lwick >= 0.85 * body) and consec_bull
    ...
    print("="*115)
    print("DIRECT METATRADER 5 BROKER REAL-TICK VERIFICATION REPORT: CP-300")
    print("="*115)
    print(f"1. Connected MT5 Server Account     : {acc.login} @ {acc.server}")
...
if __name__ == '__main__':
    run_cp300_mt5_verified_development()
