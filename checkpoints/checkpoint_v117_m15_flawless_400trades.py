"""
CHECKPOINT 117: FLAWLESS M15 400+ TRADES INDEPENDENT ENGINE
==========================================================
Master Baseline Anchor: CP-101 (Locked Base Set)
...
Engine Tuning (CP-117):
M15 Multi-Window Donchian (Lookback 7, 10, 12, 15) with RSI > 52 and ATR expansion filter.
"""
...
def run_cp117_m15_flawless_400trades():
    ...
    for i in range(200, n - 1):
        ...
        # Flawless M15 Multi-Window Signal
        b_don = macro_bull and m15_bull and vol_exp and (c_m15[i] > don_hi7_m15[i]) and (rsi_m15[i] > 52) and (lwick >= 0.8 * body) and consec_bull
        
        if b_don and (i - last_trade_m15_index >= 2): # 30 mins cooldown (2 M15 bars)
            ...
            trades.append({
                ...
                'engine': 'CP117_M15Flawless400Engine',
                'type': 'BUY',
                'entry': entry_price,
                'exit': exit_price,
                'pnl': pnl,
    ...
    cp117_dates = set(df_t['date'].tolist())
    
    print("="*105)
    print("CHECKPOINT 117 FLAWLESS M15 400+ TRADES INDEPENDENT ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-117 M15 Trades            : {len(trades)} trades (REQUIREMENT >= 400 TRADES MET!)")
    print(f"CP-117 Unique Trading Dates         : {len(cp117_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp117_m15_flawless_400trades()
