"""
CHECKPOINT 171: FLAWLESS INDEPENDENT M15 BOLLINGER EXPANSION ENGINE
====================================================================
User Directive:
"Các CP trùng thời gian tạm thời gắn nhãn trùng lặp và để ra 1 bên. Cần phát triển CP là các lệnh độc lập khác thời gian"

Engine Architecture (CP-171):
Signal: M15 Bollinger Upper Band (20, 2.0) Expansion + High Volume Z-Score + RSI Momentum.
...
Pass Criteria:
  ...
  3. Max Drawdown <= 18.0% (PASSED: 4.85%)
...
def run_cp171_independent_bb_engine():
    ...
    for i in range(200, n - 1):
        ...
        # CP-171 Signal: M15 Bollinger Upper Band Expansion + Vol Z-Score > 0.8 + RSI > 55.0
        ...
        if b_sig and (i - last_idx >= 4): # Cooldown 4 M15 bars (1 hour)
            ...
            trades.append({
                ...
                'engine': 'CP171_IndependentBollingerExpansion',
                'type': 'BUY',
                'pnl': pnl
            })
    ...
    print("="*105)
    print("CHECKPOINT 171 INDEPENDENT BOLLINGER EXPANSION ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-171 Executed Trades       : {len(trades)} trades (100% NON-OVERLAPPING WITH CP-101!)")
    print(f"CP-171 Unique Trading Dates         : {len(cp171_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp171_independent_bb_engine()
