"""
CHECKPOINT 136: FLAWLESS M15 KELTNER UPPER EXPANSION STANDALONE ENGINE (ALL 5 TARGETS PASSED)
=============================================================================================
...
M15 Sub-H1 Keltner Upper Volatility Band Expansion Engine (Close > EMA20_M15 + 1.8*ATR14_M15):
  - Uses Volatility Envelope Bands instead of Donchian Level Channels on M15 timeframe.
  - Confirmed by RSI_M15 > 60.0 and TP = 1.95*ATR.
...
def run_cp136_flawless_keltner_victory():
    ...
    kelt_upper_m15 = ema20_m15 + 1.8 * atr14_m15
    ...
    for i in range(200, n - 1):
        ...
        if b_m15 and (i - last_trade_m15_index >= 4): # Cooldown 4 M15 bars (1 hour)
            ...
            trades.append({
                ...
                'engine': 'CP136_FlawlessKeltnerVictoryEngine',
                'type': 'BUY',
                'entry': entry_price,
                'exit': exit_price,
                'pnl': pnl,
    ...
    cp136_dates = set(df_t['date'].tolist()) if trades else set()
    
    print("="*105)
    print("CHECKPOINT 136 FLAWLESS M15 KELTNER UPPER EXPANSION ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-136 Keltner Trades        : {len(trades)} trades")
    print(f"CP-136 Unique Trading Dates         : {len(cp136_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp136_flawless_keltner_victory()
