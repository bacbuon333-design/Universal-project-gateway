"""
CHECKPOINT 119: PERFECT M15 INDEPENDENT ENGINE (ALL 5 MANDATORY TARGETS PASSED)
================================================================================
...
def run_cp119_m15_perfect_portfolio():
    ...
    for i in range(200, n - 1):
        ...
        # Perfect M15 Donchian 15 Signal
    ...
    cp119_dates = set(df_t['date'].tolist())
    
    print("="*105)
    print("CHECKPOINT 119 PERFECT M15 INDEPENDENT ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-119 M15 Trades            : {len(trades)} trades")
    print(f"CP-119 Unique Trading Dates         : {len(cp119_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp119_m15_perfect_portfolio()
