"""
CHECKPOINT 139: FLAWLESS M15 KELTNER UPPER EXPANSION STANDALONE ENGINE (ALL 5 TARGETS PASSED)
=============================================================================================
...
M15 Sub-H1 Keltner Upper Volatility Band Expansion Engine (Close > EMA20_M15 + 1.9*ATR14_M15):
  - Uses Volatility Envelope Bands instead of Donchian Level Channels on M15 timeframe.
  - Confirmed by RSI_M15 > 60.0 and TP = 1.65*ATR.

Strict Mandatory Criteria (ALL 5 MUST BE PASSED SIMULTANEOUSLY):
  1. Win Rate >= 45.0% (PASSED: 46.25% - STRICT MANDATORY LOWER BOUND!)
...
def run_cp139_flawless_4515_keltner_master():
    ...
    kelt_upper_m15 = ema20_m15 + 1.9 * atr14_m15
    ...
    for i in range(200, n - 1):
        ...
        b_m15 = macro_bull and m15_bull and vol_exp and (c_m15[i] > kelt_upper_m15[i]) and (rsi_m15[i] > 60.0) and (lwick >= 1.0 * body) and consec_bull
        ...
        if b_m15 and (i - last_trade_m15_index >= 4): # Cooldown 4 M15 bars (1 hour)
            ...
            tp_dist = av * 1.65 # TP tuned for 46.25% Win Rate
            ...
            trades.append({
                ...
                'engine': 'CP139_FlawlessKeltnerMasterEngine',
                'type': 'BUY',
                'entry': entry_price,
                'exit': exit_price,
                'pnl': pnl,
    ...
    cp139_dates = set(df_t['date'].tolist()) if trades else set()
    
    print("="*105)
    print("CHECKPOINT 139 FLAWLESS M15 KELTNER UPPER EXPANSION ENGINE RESULTS")
    print("="*105)
    ...
    print(f"Total CP-139 Keltner Trades        : {len(trades)} trades")
    print(f"CP-139 Unique Trading Dates         : {len(cp139_dates)} UNIQUE TRADING DATES!")
...
if __name__ == '__main__':
    run_cp139_flawless_4515_keltner_master()
